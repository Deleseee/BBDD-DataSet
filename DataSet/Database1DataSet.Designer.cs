...
namespace DataSet {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class UsuarioDataTable : global::System.Data.TypedTableBase<UsuarioRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuarioRow AddUsuarioRow(int Id, string Nombre, int Edad, bool Activo) {
...
namespace DataSet.Database1DataSetTableAdapters {
    ...
    public partial class UsuarioTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Usuario] WHERE (([Id] = @Original_Id) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Edad = 1 AND [Edad] IS NULL) OR ([Edad] = @Original_Edad)) AND ((@IsNull_Activo = 1 AND [Activo] IS NULL) OR ([Activo] = @Original_Activo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuario] ([Id], [Nombre], [Edad], [Activo]) VALUES (@Id, @Nomb" +
                "re, @Edad, @Activo);\r\nSELECT Id, Nombre, Edad, Activo FROM Usuario WHERE (Id = @" +
                "Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuario] SET [Id] = @Id, [Nombre] = @Nombre, [Edad] = @Edad, [Activo] = @Activo WHERE (([Id] = @Original_Id) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Edad = 1 AND [Edad] IS NULL) OR ([Edad] = @Original_Edad)) AND ((@IsNull_Activo = 1 AND [Activo] IS NULL) OR ([Activo] = @Original_Activo)));
SELECT Id, Nombre, Edad, Activo FROM Usuario WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataSet.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nombre, Edad, Activo FROM dbo.Usuario";
        ...
        public virtual int Delete(int Original_Id, string Original_Nombre, global::System.Nullable<int> Original_Edad, global::System.Nullable<bool> Original_Activo) {
        ...
        public virtual int Insert(int Id, string Nombre, global::System.Nullable<int> Edad, global::System.Nullable<bool> Activo) {
        ...
        public virtual int Update(int Id, string Nombre, global::System.Nullable<int> Edad, global::System.Nullable<bool> Activo, int Original_Id, string Original_Nombre, global::System.Nullable<int> Original_Edad, global::System.Nullable<bool> Original_Activo) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, global::System.Nullable<int> Edad, global::System.Nullable<bool> Activo, int Original_Id, string Original_Nombre, global::System.Nullable<int> Original_Edad, global::System.Nullable<bool> Original_Activo) {
            return this.Update(Original_Id, Nombre, Edad, Activo, Original_Id, Original_Nombre, Original_Edad, Original_Activo);
        }
    }
